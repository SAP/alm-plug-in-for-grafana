...
With the SAP ALM plug-in for REST interface you are able to connect your **SAP Cloud ALM** or **SAP Focused RUN** tenants and get data in table format or time-series format to get new insights into your various ALM processes.
...
- [Data source plug-in](sap-alm-dp-api-datasource) — see the [full documentation](sap-alm-dp-api-datasource/README.md) for installation, setup, and query configuration.
...
If you want to learn more about the SAP Cloud ALM API:
